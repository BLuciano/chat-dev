(function() {
    "use strict";
    angular.module("chatApp", [ "ngRoute", "firebase" ]).controller("mainCtrl", [ "$scope", "$route", function($scope, $route) {
        $scope.currentRoom = "General";
        $scope.rooms = [ "General", "HTLM", "CSS", "JavaScript", "PHP", "Ruby", "Java", "IOS", "Android", "Design" ];
...
angular.module("chatApp").controller("loginCtrl", [ "$scope", "$firebaseAuth", "$firebaseArray", function($scope, $firebaseAuth, $firebaseArray) {
    ...
    $scope.createUser = function() {
        ...
        if (usernameExists()) {
            ...
            $firebaseAuth(loginRef).$createUser({
                ...
                saveUser();
                //call saveUser once the form successfully passes.
                clearFields();
...
angular.module("chatApp").controller("roomCtrl", [ "$scope", "$firebaseArray", function($scope, $firebaseArray) {
    ...
    $scope.sendMessage = function() {
        if ($scope.message.length === 0) {} else {
