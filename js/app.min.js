(function() {
    "use strict";
    angular.module("chatApp", [ "ngRoute", "firebase" ]).controller("mainCtrl", [ "$scope", "$route", "$firebaseArray", "$firebaseObject", "auth", function($scope, $route, $firebaseArray, $firebaseObject, auth) {
...
angular.module("chatApp").controller("loginCtrl", [ "$scope", "$firebaseAuth", "login", function($scope, $firebaseAuth, login) {
